  ...
  public static void main(String[] args) {
    ...
    try{
	    ...
	    while (!command.equals("quit")) 
      {
        ...
        catch(IOException | NumberFormatException |BadAccountException | BadTransactionException e) 
        {
  ...
  */
  private void doDeposit() throws IOException, BadAccountException, BadTransactionException{
    ...
    try
    {
      ...
      // if(amount < 0)
      //   throw new IOException("Error: Cannot deposit a negative amount.");
      // else
    ...
    {
      throw new NumberFormatException("Error: Invalid number format.");
    }
  }
  ...
  private void doWithdraw() throws IOException, BadAccountException, BadTransactionException{
    ...
    try
    {
      ...
      // if(amount < 0)
      //   throw new IOException("Error: Cannot withdraw a negative amount.");
      // else
